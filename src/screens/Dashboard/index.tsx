...
const Dashboard = ({ navigation }: any) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#000' }}>
      <ImageBackground source={require("../../assets/images/back.jpeg")} style={[styles.background, { height: screenHeight / 2.3 }]}>
        <StatusBar translucent backgroundColor="transparent" />
        <View style={[styles.container, { padding: screenWidth * 0.05, marginVertical: screenHeight * 0.03 }]}>
          ...
          <View style={styles.card}>
            ...
            />
            <View>
              <Text style={[styles.cardTitle, { fontSize: screenWidth * 0.045 }]}>ANZ Business Essentials</Text>
            </View>
